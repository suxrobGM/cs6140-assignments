...
def neighborhood_price_relation(dataset : list) -> None:
    ...
    for data in dataset:
        ...
        if 'host_neighbourhood' in listings.columns and 'price' in listings.columns:
            ...
            print("The required fields 'neighbourhood' and 'price' are not in the " + city + " dataset.")

def roomType_price_relation(dataset : list) -> None:
    ...
    for data in dataset:
        ...
        if 'room_type' in listings.columns and 'price' in listings.columns:
            ...
            print("The required fields 'room_type' and 'price' are not in the " + city + " dataset.")
    
    
def neighbourhood_minimum_nights_relation(dataset : list) -> None:
    ...
    for data in dataset:
        ...
        if 'host_neighbourhood' in listings.columns and 'minimum_nights' in listings.columns:
            ...
            print("The required fields 'neighbourhood' and 'minimum_nights' are not in the " + city + " dataset.")